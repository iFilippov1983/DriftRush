...
namespace RaceManager.Tools
{
    internal static class ResourcePath
    {
        ...
        public const string DriftScoresIndicatorViewPrefab = "Prefabs/UI/DriftScoresIndicator";
        public const string AnimatableCurrencyPrefab = "Prefabs/UI/AnimatableCurrency";
