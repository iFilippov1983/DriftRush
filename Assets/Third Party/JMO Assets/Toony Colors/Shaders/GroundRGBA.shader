...
Shader "Toony Colors Pro 2/User/My TCP2 Shader"
{
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float4 __blendTexture3 = ( TCP2_TEX2D_SAMPLE(_BlendTex3, _BlendTex3, input.texcoord0.xy * _BlendTex3_ST.xy + _BlendTex3_ST.zw).rgba );
