...
public class GameController :MonoBehaviour
{
	...
	public static CarControllerMain PlayerCar { get { return Instance.m_PlayerCar; } }
	public static bool RaceIsStarted { get { return true; } }
	public static bool RaceIsEnded { get { return false; } }

	CarControllerMain m_PlayerCar;
	List<CarControllerMain> Cars = new List<CarControllerMain>();
	...
	protected virtual void Awake ()
	{
		...
		Cars.AddRange (GameObject.FindObjectsOfType<CarControllerMain> ());
